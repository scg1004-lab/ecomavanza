...
const FloatingWhatsApp: React.FC = () => {
  return (
    <a
      href="https://wa.me/34600000000" // Reemplaza con el número de WhatsApp real
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-8 left-8 z-[60] flex items-center bg-white rounded-full p-2 pr-2 pl-6 shadow-[0_8px_30px_rgb(0,0,0,0.12)] border-[3px] border-[#25D366] hover:scale-105 transition-transform duration-300 group"
    >
